...
allGames.push(new Game(id = 2, description = 'Punishing Gray Raven', abbreviation = 'PGR', img = 'img/pgr-icon.png', capStamina = 160, staminaPerMinute = 6, currentStamina = 0, maxStaminaAt = '', dateMaxStamina = new Date(), pendingTasks = ''));
allGames.push(new Game(id = 3, description = 'Honkai Star Rail', abbreviation = 'HSR', img = 'img/star-rail-icon.png', capStamina = 240, staminaPerMinute = 6, currentStamina = 0, maxStaminaAt = '', dateMaxStamina = new Date(), pendingTasks = ''));
